...
| -------- | -------- | -------- |
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.     | **TB1: Jack Eddie Roque Tello** Realicé presentaciones orales claras y estructuradas sobre los avances del proyecto CareMe. Coordiné algunas reuniones informales para explicar el progreso, las herramientas usadas y los retos técnicos. Intenté comunicarme con mis compañeros para organizar trabajo colaborativo recibiendo respuesta tardía.  **TP1: Jack Eddie Roque Tello** Presenté de forma clara los resultados del desarrollo frontend, integración de la API y la documentación. Respondí consultas y aclaré dudas técnicas a profesores y revisores del proyecto. Mantengo una comunicación profesional con los stakeholders del proyecto, aportando claridad en cada entrega.  **TB2:Stanley Gutierrez Tume:Participé activamente en las reuniones de planificación y retrospectiva de sprints con el equipo multidisciplinarioSantos Torres Juan Manuel:Presenté mis avances y tareas en las reuniones semanales del proyecto, explicando procesos de desarrollo y dificultades.Lapa de la Cruz Gabriel Omar:Ayudé en  la funcionalidad y estructura de los endpoints REST al equipo durante una sesión técnica.Johan Karl Bottger Salazar:Ayudé en la partes técnicas del equipo sobre el uso de servicios como ngx-translate y Angular Router.Jack Eddie Roque Tello:Coordiné tareas con miembros de diferentes roles (frontend, backend, diseño) para asegurar coherencia en el desarrollo. | Durante el TB1 y TP1, la comunicación oral fue realizada íntegramente por mi persona, Jack Eddie Roque Tello, debido a la falta de participación de mis compañeros. A pesar de la ausencia de trabajo en equipo, mantuve la objetividad y claridad necesarias para comunicar avances técnicos y administrativos en el proyecto, cumpliendo con los estándares esperados en un entorno profesional de ingeniería. Durante el desarrollo del proyecto(TB2), demostramos la capacidad de comunicar ideas y resultados de manera clara, objetiva y adaptada al contexto técnico del equipo. A través de reuniones de planificación, coordinación y revisión, logramos expresar los aportes, resolver dudas de compañeros y facilitar el trabajo conjunto entre distintos roles del proyecto. Esta interacción constante fortaleció la colaboración multidisciplinaria y aseguró el avance sostenido del sistema en cada sprint. |
*Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.     |  **TB1: Jack Eddie Roque Tello** Elaboré la documentación técnica y administrativa del proyecto CareMe, incluyendo Lean UX, User Stories, Sprint Planning y backlog. Redacté los antecedentes, problemáticas, perfiles y análisis competitivo con lenguaje técnico claro y accesible. Documenté el desarrollo de la Landing Page con evidencias gráficas y texto explicativo. **TP1: Jack Eddie Roque Tello** Realicé la documentación del desarrollo frontend usando Angular, integración con API, uso de ngx-translate, Angular Material y Router. Elaboré manuales y reportes para las entregas del sprint, incluyendo conclusiones y evidencias de pruebas. Organicé y mantuve actualizado el repositorio de documentación y código.Stanley Gutierrez Tume: Documenté cada sprint en un archivo Markdown con objetivos, tareas, responsables y evidencias.Santos Torres Juan Manuel: Redacté las historias de usuario con criterios de aceptación claros en formato Gherkin (DADO, CUANDO, ENTONCES).Lapa de la Cruz Gabriel Omar:Elaboré tablas de endpoints y documentación técnica del backend para los servicios REST del sistema.Johan Karl Bottger Salazar: Redacté el informe del proyecto incluyendo capítulos de requerimientos, diseño, implementación y validación.Jack Eddie Roque Tello:Coordiné por mensajes escritos (chat y GitHub) con el equipo para gestionar entregas, dudas y conflictos.Mejoré el backend| En ambas entregas, la comunicación escrita fue responsabilidad exclusiva mía, garantizando objetividad, coherencia y claridad. Esta documentación permitió evidenciar el avance del proyecto, facilitar la evaluación y asegurar la trazabilidad de las actividades realizadas, evidenciando compromiso y profesionalismo a nivel individual.En ambas entregas, la comunicación escrita fue responsabilidad exclusiva mía, garantizando objetividad, coherencia y claridad. Esta documentación permitió evidenciar el avance del proyecto, facilitar la evaluación y asegurar la trazabilidad de las actividades realizadas, evidenciando compromiso y profesionalismo a nivel individual.Como equipo, logramos comunicarnos de manera clara y objetiva durante todas las etapas del proyecto. A través de reuniones de planificación, seguimiento y retrospectiva, compartimos ideas, avances y dificultades, adaptando el lenguaje según el perfil de cada integrante. Esta interacción efectiva entre miembros con distintos roles y especialidades permitió coordinar mejor las tareas, resolver problemas de forma colaborativa y mantener una visión común del producto. Reconocemos que mejorar la comunicación fue clave para fortalecer nuestro rendimiento colectivo y alcanzar los objetivos establecidos. |
